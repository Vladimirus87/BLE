...
class SignInViewController: CAViewController, UITableViewDelegate, UITableViewDataSource, EditAccountTableViewCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        let pathData = Bundle.main.path(forResource: "SignIn", ofType: "plist")
